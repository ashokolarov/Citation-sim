...
class Model:
    ...
    def symmetric_nonzero_response(self, plot_eigs=False):
        ss = self.state_space_systems['sp']
    ...
    def asymmetric_nonzero_response(self, plot_eigs=False):
        ss = self.state_space_systems['dr']
...
if __name__ == "__main__":
    datafile = '../preflight/flightdata.csv'
    excel_file = '../preflight/PFD_11-03-2021fl1.xlsx'
    ...
    #plane.compare_eigen_parameters()
